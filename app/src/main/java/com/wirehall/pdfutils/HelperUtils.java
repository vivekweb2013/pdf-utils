...
public class HelperUtils {
  private static final String PRIVACY_POLICY_URL =
      "https://sites.google.com/view/pdf-utils-privacy-policy";
  private static final String SOURCE_CODE_URL = "https://github.com/vivekweb2013/pdf-utils";
  private static final String BUG_REPORT_URL =
      "https://github.com/vivekweb2013/pdf-utils/issues";

  private static final String APP_PACKAGE_NAME = "com.wirehall.pdfutils";
  ...
  public static void openPrivacyPolicyIntent(Context context) {
    context.startActivity(
        new Intent(Intent.ACTION_VIEW, Uri.parse(HelperUtils.PRIVACY_POLICY_URL)));
  }
